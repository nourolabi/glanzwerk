...
class GlanzwerkInvoicePDF(FPDF):
    ...
    def header(self):
        ...
        self.set_xy(55, 15) # Adjust position to be next to the logo
        self.multi_cell(0, 5, "Glanzwerk Rheinland\nKrasnaer Str. 1\n56566 Neuwied, Deutschland", 0, "L")
        self.ln(5)
    ...
    def invoice_header(self, invoice_number):
        ...
        self.set_x(120)
        self.cell(70, 6, f"Rechnungsdatum: {formatted_current_date}", 0, 1, "L")
        self.set_x(120)
        self.cell(70, 6, f"Fälligkeitsdatum: {formatted_due_date}", 0, 1, "L")
...
def generate_invoice_pdf_new(invoice_data):
    ...
    invoice_number = f"2025-{current_time_str}"
